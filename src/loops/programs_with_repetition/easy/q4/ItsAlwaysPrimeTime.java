...
/*
 * Write a program to keep asking the user to enter a number until they enter a prime number that is less than 50. Make sure your output matches the sample. 
