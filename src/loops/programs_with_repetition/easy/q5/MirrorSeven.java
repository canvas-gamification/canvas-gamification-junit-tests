...
/*
Write a program to keep asking the user to enter a number until they enter a positive palindromic number divisible by 7
(i.e. it is the same forwards and backwards). Once it receives a valid integer, the program should print the message
