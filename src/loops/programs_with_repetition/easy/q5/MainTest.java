...
public class MainTest extends BaseTest {
    ...
    public void printsMessageCorrectly(int number) throws InvalidClauseException {
    ...
    public void loopsUntilValidInputReceived(ArrayList<Integer> inputs) throws InvalidClauseException {
        TestOption.incorrectStructureErrorMessage = "Your program does not keep looping until a valid input is received.";
