...
public class MainTest extends BaseTest {
    ...
    static Stream<Arguments> invalidInputProvider() {
        return Stream.of(Arguments.of(new int[]{0}, 6), Arguments.of(new int[]{1}, 38), Arguments.of(new int[]{0, 1, -1, -4, -5 - 11, -57, -2, -558}, 479));
    }

    @ParameterizedTest
    @MethodSource("validInputProvider")
    void worksWithValidInputs(int input) throws InvalidClauseException {
        TestOption.incorrectStructureErrorMessage = "Your program does not print all the composite numbers between 2 and an input n.";
