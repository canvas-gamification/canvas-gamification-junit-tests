package loops.simple_programs_with_repetition.easy.q1;

/*
Write a program that will ask the user to input a sentence and then ask them for an "n", which represents how many times
