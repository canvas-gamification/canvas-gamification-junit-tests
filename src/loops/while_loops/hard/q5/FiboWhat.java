...
/*
Write a program that will ask the user to input a number n, and print all the terms in the fibonacci sequence up to
...
then 3, then 5, and so on. The pattern goes like 0, 1, 1, 2, 3, 5, 8 ...etc). If the user inputs a number less than 0,
the program should print the error message "Invalid input!".
