...
public class MainTest {
    ...
    public void createsEvenArrayCorrectly(int[] input, int[] ans) throws Throwable {
        Object[][] arguments = {
                {input, int[].class}
        };
        MethodTest m = new MethodTest(OnlyEven.class, "onlyEven", arguments);
        Object output = m.callMethod();
        CustomAssertions._assertArrayEquals(ans, output, "Your method does not correctly create an array using only the even numbered indices of an input array.");
    }
