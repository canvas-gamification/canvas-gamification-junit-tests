...
public class MainTest {
    ...
    static Stream<Arguments> inputProvider(){
        return Stream.of(Arguments.of(new int[]{2, 4, 6, 8, 10, 12}, 7, 30),
    ...
    void correctSelectiveSumMethod(int [] input, int n, int sum){
        int output = (int) MethodUtil.invokeIfMethodExists(SumTimes.class, "selectiveSum", new Object[]{input, n},
                int[].class, int.class);
        assertEquals(sum, output, "Your method does not correctly calculate the sum of the values in an array greater than a given n.");
    }
}
