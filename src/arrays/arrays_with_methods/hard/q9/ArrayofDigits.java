...
powerN that takes an integer array and squares each element. The return type of powerN should be void, and it should be generalized to handle any input array length. Back in the main
