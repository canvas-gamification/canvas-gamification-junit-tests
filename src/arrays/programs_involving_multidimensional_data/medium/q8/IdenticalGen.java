...
/*
Write a Java program that creates a random integer in the range of 1 to1000 (inclusive of both values), and print it.
Then, the program will also create a 2D array of the size of the 5 by 5. Next, use a method called squareRoot to
