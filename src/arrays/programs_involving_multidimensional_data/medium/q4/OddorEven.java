...
(inclusive of both values), and print each row in a line. Then, use a method named count that creates a 1D array with two 
elements and counts the number of even and odd numbers in the 2D array. Use the index 0 for even numbers and index 1 for 
odd numbers. Print out the resulting 1D array.
