...
public class MainTest extends BaseTest {
    ...
    void printsCorrectOutput(double[] input) {
        ...
        CustomAssertions._assertEquals(ans, Double.parseDouble(getItemByName("ans")), 0.00001, "Your program does not correctly print the minimum value of the double array.");
    }
