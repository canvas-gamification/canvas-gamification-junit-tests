...
public class MainTest extends BaseTest {
    ...
    void correctMainMethod(double[] input) throws InvalidClauseException {
        TestOption.incorrectStructureErrorMessage = "Your main method does not correctly print the indices of potential teaching assistants.";
        runWithInput(
                arrayToInput(input),
                new Clause[]{
    ...
    static Stream<Arguments> InputProvider() {
        return Stream.of(
                ...
                Arguments.of(generateRandomArray(0.0, 100, 100)),
                Arguments.of(generateRandomArray(pivot + 0.0001, 100, 100)),
                Arguments.of(generateRandomArray(0.0, pivot, 100)),
    ...
    void testForPGSMethod(double[] input) throws Throwable {
        ...
        m.setIncorrectMethodStructureErrorMessage("Your PGS method does not correctly print the indices of potential teaching assistants.");
        m.callMethod();
    }
}
