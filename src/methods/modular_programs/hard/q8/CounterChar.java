...
/**
 * [J]Write a program with a method called charCounter that asks the user for a
 * sentence and then counts the number of characters in the sentence. (Hint:
 * Space / ' ' is not considered a character)
 * 
 * Sample output:
 *    Enter a sentence
 *    Hello world
