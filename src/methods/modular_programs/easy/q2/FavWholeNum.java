...
value (true if it is even, and false if it is not). Second, multiply the number by 𝛑, and return that value. The main method
should print if the number is even or odd, and what the number multiplied by 𝛑 is.
...
public class FavWholeNum {
    public static void main(String[] args) {
        ...
        System.out.println("Your number multiplied by PI is: " + piMult(fav));
    }
    ...
    public static double piMult(int a) {
        return Math.PI * a;
    }
}
