...
meanCalc and the other called medianCalc.Finally, the program should output the median and mean in the main method.
...
public class MeanNMedian {
    public static void main(String[] args) {
        ...
        int b = 2;
        int c = 34;
        System.out.println("The average of the three integers is " + meanCalc(a, b, c));
        System.out.println("The median of the three integers is " + medianCalc(a, b, c));
    }

    public static double meanCalc(int a, int b, int c) {
        return (a + b + c) / 3.0;
    }
