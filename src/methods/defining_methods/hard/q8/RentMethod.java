...
/**
 * [J] Write a Java Program that asks users for the cost of rent for their housing per month. Then
 * write a Java method that accepts that value and returns the cost per year for housing. Let's call
 * this method rentCalcYear.
 * 
 * Sample output:
