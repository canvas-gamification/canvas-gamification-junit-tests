...
follows: if the integer is less than or equal to five, then return a string saying: "You've watched <the movie name> a
few times!"; if the integer is less than or equal to 10 and greater than 5, return a string saying: "You've watched <the
movie name> a lot of times!"; if the integer is greater than 10, then return a string saying: "You've watched <the movie
name> so many times! Wow!". Call your method movieCounter and pass in the movie name and the number of times you have
watched the movie respectively.
