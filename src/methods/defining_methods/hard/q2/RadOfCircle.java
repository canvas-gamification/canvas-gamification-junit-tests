...
/*
Write a Java Program that asks users for the radius of a circle as a double, then determines the area and the
...
program should also output the calculated area and circumference to two decimal places using printf. Ensure that your
