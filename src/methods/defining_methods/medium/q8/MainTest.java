...
public class MainTest extends BaseTest {
    ...
    static Stream<Arguments> costPerCalcInputProvider(){
        return Stream.of(Arguments.of(5, 5, 1.0), Arguments.of(2.5, 8, 3.2), Arguments.of(3, 15.2, 5.066666666666666), Arguments.of(6.2, 16.3, 2.629032258064516), Arguments.of(-5, 13, -1.0), Arguments.of(1234567, 87, 7.047005144313756E-5), Arguments.of(23, 456789, 19860.391304347828));
    }
    ...
    void correctCostPerCalcMethod(double weight, double cost, double price) throws Throwable {
        ...
        CustomAssertions._assertEquals(price, output, 0.0001, "Your costPerCalc method does not calculate the correct cost per kg.");
    }
