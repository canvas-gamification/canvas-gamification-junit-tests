...
should already be declared and initialized in the main method. Your program should contain a method called powerCalc that
takes both integer values as input parameters and returns a double of the first integer raised to the power of the second.
