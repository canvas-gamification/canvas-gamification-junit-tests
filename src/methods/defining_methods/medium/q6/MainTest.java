...
public class MainTest extends BaseTest {
    ...
    static Stream<Arguments> lengthCubeInputProvider(){
        return Stream.of(Arguments.of(64, 4.0), Arguments.of(45.9, 3.5804495757820107), Arguments.of(1234567, 107.27657218553581), Arguments.of(-27, -1.0), Arguments.of(1, 1.0), Arguments.of(0.75, 0.9085602964160698));
    }
    ...
    void correctLengthCubeMethod(double in, double side) throws Throwable {
        ...
        CustomAssertions._assertEquals(side, output, 0.00001, "Your lengthCube method does not correctly calculate the side length.");
    }
