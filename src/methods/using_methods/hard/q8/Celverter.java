...
/*
Write a Java Program called Celverter that asks users for the current temperature in Celsius, then write a method called
tempCalc that accepts that value as an input parameter and returns the temperature in Fahrenheit. The program should
