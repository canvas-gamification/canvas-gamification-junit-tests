...
one input, and the length of all the input strings added together otherwise. You do not need a main method, and the
program should not have any printed output.
 */
