...
/*
Create a class with a static method called lengthString() that returns an integer. Overload this method twice so that it
...
public class OneToThree {
    ...
    public static int lengthString(String a, String b) {
        String x = a + b;
        return x.length();
    }

    public static int lengthString(String a, String b, String c) {
        String x = a + b + c;
        return x.length();
    }
}
