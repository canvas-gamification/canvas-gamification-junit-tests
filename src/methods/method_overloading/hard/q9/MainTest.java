...
public class MainTest extends BaseTest {
  ...
  public Clause[] testSentence() {
    return new Clause[] {
        new StringLiteral("The username for Joe with the age of 21 is: Joe.21"),
        new NewLine(),
        new StringLiteral("The username for Madi with the age of 19 is: Madi.19"),
    };
  }

  public void runMain() {
    Overload9.main(new String[0]);
  }
  ...
  void userNameWithNameAgeCorrect(String name, int age, String username) throws Throwable {
    ...
    Object output = MethodUtil.invokeIfMethodExists(Overload9.class, "userName", new Object[] { name, age },
  ...
  void userNameWithAgeNameCorrect(int age, String name, String username) throws Throwable {
    String errMsg = "Your method \"userName()\" does not give the correct username.";
    Object output = MethodUtil.invokeIfMethodExists(Overload9.class, "userName", new Object[] { age, name },
