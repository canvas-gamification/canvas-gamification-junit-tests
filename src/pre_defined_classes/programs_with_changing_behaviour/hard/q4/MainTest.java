...
public class MainTest extends BaseRandomTest {
    ...
    static int independentNumbers;      // Keeps track of how many times all digits of the passcode are equal to each other
    ...
    @RepeatedTest(50)
    public void generatedNumbersAreIndependent(){           // Independent Numbers Workaround
