...
public class MainTest extends BaseTest {
    ...
    public void worksWithDifferentStrings(String input1, String input2) throws InvalidClauseException{
        TestOption.incorrectStructureErrorMessage = "Your program does not work with strings that are not matching.";
