...
weak if it can be easily guessed based on the criteria above. The program will print true or false depending on whether
the inputted password is weak. Assume user always enter a password with at least 4 characters.
