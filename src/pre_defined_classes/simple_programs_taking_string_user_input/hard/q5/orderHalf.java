...
/*
Some restaurant employees only write down the important items of an order rather than writing down everything. At FakeOK
restaurant, the servers only write down the first half of the orders. To replicate this process, make a Java program to
ask for a customer's order, then only print out the first half of the input.
