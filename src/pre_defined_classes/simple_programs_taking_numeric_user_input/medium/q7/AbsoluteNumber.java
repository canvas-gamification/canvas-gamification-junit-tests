...
multiply the score by the score modifier, and display the new score to the user. Assume the user only enters a valid score.
...
public class AbsoluteNumber {
    public static void main(String[] args) {
        ...
        System.out.println("Enter your score between -10 and 10 (inclusive): ");
