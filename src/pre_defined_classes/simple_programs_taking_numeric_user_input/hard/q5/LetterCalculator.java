...
/*
Many schools calculate a student's grade point average (GPA) by using the following formula : GPA = (percentage grade / 20 ) - 1.
Using this formula, make a program that asks the user for a percentage average, then converts that percentage to a GPA
