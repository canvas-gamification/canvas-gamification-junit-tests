...
/*
Write a program that will display a menu to the user and ask the user for their order and how many of the item they want.
Then display the total amount their order would cost based on the following information: $10 for a Pepperoni Pizza, $15
for Spaghetti Alfredo, $8 for a Panna Cotta, and $3 for a can of soda. If the user enters a number corresponding to a
number not on the menu, the program should print "That will cost: $0", followed by
“Sorry, we weren't expecting that. Please try again.” on the next line. Assume the user inputs integers, and enters a
non-negative integer for the order quantity. Make sure your output matches the example.
