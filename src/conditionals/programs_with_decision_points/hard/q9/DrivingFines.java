 ...
 * is driving 31 - 50 km/h above the speed limit, their fine is $100. If a person is driving 51 km/h above the speed
 * limit, their fine is $150. If a person is in a school zone, then their fine is doubled. When asking if the person
 * was speeding at school zone, enter whether "True" or "False". Make sure to print “Invalid Input!” if the input is
 * invalid.
 * 
 * Sample Output:
