...
public class MainTest extends BaseTest {
    ...
    static Stream<Arguments> inputProvider() {
        return Stream.of(
            // Test 1: Sum < 10. For example, num1 = 3 and num2 = 4 => 3+4 = 7.
            Arguments.of(3, 4, "Very small sum."),
    ...
    void printsCorrectClassification(int num1, int num2, String expectedPhrase) throws InvalidClauseException {
        TestOption.incorrectStructureErrorMessage = "Your program did not print the correct classification for the given numbers.";
